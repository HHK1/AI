...
%talk about programmed logic vs infered
%prolog and other examples

%Give some definitions: supervised / unsupervised learning
%Exploration problem  neural network
...
%Moore Law decrease in price / availability

%Cloud computing

%Examples with numbers of trained algorithms
...
\href{http://www2.deloitte.com/content/dam/Deloitte/uk/Documents/uk-futures/london-futures-agiletown.pdf}
...
Progress we've analyzed before in the NLP area will reshape the way we work.
For instance, most communication is currently handled through written form,
we basically communicate with our keyboard for work. NLP can enable a change here,
we'll be able to work using our voice to virtually communicate (as we currently do with emails).
This is an example of the positive impact machine learning can have on jobs,
